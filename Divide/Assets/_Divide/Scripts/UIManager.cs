...
namespace Divide
{
    public class UIManager : MonoBehaviour
    {
        ...
        public GameObject spawnDirItem;
        ...
        public static event System.Action ChangePolygon;
        ...
        {
            //		changePolygonBtn.SetActive (true);
            header.SetActive(true);
            title.SetActive(false);
        ...
        public void ShowGameOverUI()
        {
            ...
            //		BoundaryControl.Instance.gameObject.SetActive (false);
            //		PolygonMesh.Instance.gameObject.SetActive (false);
            //		HoldGameFieldBG.Instance.ClearMesh ();
            spawnDirItem.SetActive(false);
            //		ShowPasedMesh.Instance.ProcessShowMeshsList ();
            header.SetActive(true);
            title.SetActive(false);
            score.gameObject.SetActive(true);
        ...
        public void ChangePolygonHandler()
        {
            if (ChangePolygon != null)
                ChangePolygon();
        }
